...
import { getRefundDetail } from "@/apps/refunds/service/refundQueries";
import { isTerminal } from "@/apps/refunds/domain/rules";
import {
  PAYMENT_METHOD_LABELS,
  REFUND_REASON_LABELS,
  REFUND_STATUS_DESCRIPTORS,
} from "@/apps/refunds/domain/types";
import { DecisionPanel } from "@/apps/refunds/ui/DecisionPanel";
...
export default async function RefundDetailPage({
  ...
  let detail;
  try {
    detail = getRefundDetail(actor, id);
  } catch (error) {
